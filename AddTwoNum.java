...
class AddTwoNum extends Frame implements  ActionListener{
Label l1,l2,l3,l4;  
TextField t1,t2;  
Button b1,b2;  
AddTwoNum()
...
addWindowListener( new  WindowAdapter() {
    ...
    if(ae.getSource()==b1)
    {
    a=Float.parseFloat(t1.getText().trim());  b=Float.parseFloat(t2.getText().trim());  c=a+b;
    l4.setText(Float.toString(c));
    }
    else
    {
    t1.setText(null);  t2.setText(null);  l4.setText(null);
    }
    }
